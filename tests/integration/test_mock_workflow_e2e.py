...
from workflow.mock.mock_manager import MockWorkflowManager


@pytest.mark.asyncio
@patch("ui.app.st")
@patch("ui.app.SessionManager", autospec=True)
@patch("ui.app.create_three_pane_layout")
async def test_e2e_mock_workflow_run_placeholder(
    mock_create_layout, mock_session_manager, mock_st
):
    """
